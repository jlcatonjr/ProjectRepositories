...
# seaborn Reference — ProjectRepositories

> Quick-reference for **seaborn 0.11.2** (library) in ProjectRepositories.
...
<!-- Document common usage patterns, best practices, and known issues for seaborn 0.11.2. -->
