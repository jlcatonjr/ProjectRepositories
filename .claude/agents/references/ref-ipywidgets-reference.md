...
# ipywidgets Reference — ProjectRepositories

> Quick-reference for **ipywidgets 7.6.5** (library) in ProjectRepositories.
...
<!-- Document common usage patterns, best practices, and known issues for ipywidgets 7.6.5. -->
