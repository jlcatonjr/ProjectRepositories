...
# scipy Reference — ProjectRepositories

> Quick-reference for **scipy 1.9.1** (library) in ProjectRepositories.
...
<!-- Document common usage patterns, best practices, and known issues for scipy 1.9.1. -->
