...
# pytest Reference — ProjectRepositories

> Quick-reference for **pytest 7.1.2** (library) in ProjectRepositories.
...
<!-- Document common usage patterns, best practices, and known issues for pytest 7.1.2. -->
