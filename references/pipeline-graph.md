...
| --- | --- | --- |
| `adversarial` | `crisis-credit-allocation-expert`, `fed-response-dag-expert`, `orchestrator`, `prairie-prosperity-expert`, `sugarscape-expert`, `visualize-energy-data-expert`, `work-summarizer` | `conflict-auditor`, `orchestrator` |
| `agent-refactor` | `agent-updater`, `code-hygiene`, `orchestrator` | `conflict-auditor`, `orchestrator` |
| `agent-updater` | `conflict-auditor`, `conflict-resolution`, `git-operations`, `orchestrator` | `agent-refactor`, `conflict-auditor`, `orchestrator` |
...
| `tool-sqlite` | `orchestrator` | `orchestrator`, `security`, `technical-validator` |
...
digraph "ProjectRepositories Agent Team" {
    ...
    "orchestrator" -> "tool-sqlite" [style=dashed];
